...
import useGetPool from '../../hook/useGetPool'



const Upcoming = ({more=false,schedule}:{more?:boolean,schedule?:string}) => {
  const naviagte=useNavigate()
  const { isLoading, data:AllPools, isError, isFetching, refetch,isSuccess ,error} = useGetPool('upcoming')
